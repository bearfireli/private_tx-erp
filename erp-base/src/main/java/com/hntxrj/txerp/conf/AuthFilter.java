...
public class AuthFilter implements Filter {
    ...
    private static final String APP_TOKEN_DRIVER = "38275t285gbhfd"; //司机app令牌
    ...
    private static final String[] APP_TOKEN = new String[]{APP_TOKEN_DRIVER}; // 其他服务令牌
    ...
    public void doFilter(ServletRequest req, ServletResponse resp, FilterChain chain) throws IOException, ServletException {
        ...
        // 验证是否是其他服务
        if (!"".equals(request.getHeader("app_token"))) {
            for (String appToken : APP_TOKEN) {
                if (appToken.equals(request.getHeader("app_token"))) {
                    return;
                }
            }
        }
