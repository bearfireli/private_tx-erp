...
public interface RollMassageService {
    ...
    //添加滚动消息信息
    void addRollMessage(String token, String content, String compid, Byte type, String beginTime,
    ...
    //修改滚动消息
    void updateRollMessage(Integer id, String compid, String content, String beginTime,
                           String endTime, Byte type) throws ErpException;
