...
public class RedisConfig extends CachingConfigurerSupport {
    ...
    @Bean
    public RedisTemplate<String, List<VehicleIdVO>> driverPushRedisTemplate(RedisConnectionFactory factory) {

        RedisTemplate<String, List<VehicleIdVO>> template = new RedisTemplate<>();
