...
@Data
@Entity
@IdClass(TaskUnrealFormula.TaskUnrealFormulaUK.class)
@Table(name = "LM_taskunrealformula")
public class TaskUnrealFormula implements Serializable {
    @Id
    @Column(name = "compid")
    ...
    static class TaskUnrealFormulaUK implements Serializable {
        ...
        public boolean equals(Object o) {
            ...
            TaskUnrealFormulaUK that = (TaskUnrealFormulaUK) o;
