 ...
 */
public interface TaskListServer {
     ...
     * @return
     */
    JSONArray getTaskList(String compid, String taskId, String eppName, String builderName, Integer taskStatus, String placing, String beginTime, String  endTime, PageBean pageBean, String opid);
