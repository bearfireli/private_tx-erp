...
import com.hntxrj.vo.ConsultSupplierVO;
import com.hntxrj.vo.PageVO;
import com.hntxrj.vo.StockInSelectCloseVO;
import com.hntxrj.vo.StockInSelectVO;
...
public interface StockInSelectService {
     ...
     * @return 原材料统计汇总
     */
    PageVO<StockInSelectVO> getStockInDetails(String matName ,String vehicleId, String supName, String compid, String beginTime, String endTime, Integer page, Integer pageSize,String saleType);
    /**
     /*原材料过磅查询结算重量
     * @param compid    企业id
     * @param beginTime 开始时间
     ...
     * @return 原材料统计汇总
     */
    PageVO<StockInSelectCloseVO> getStockInSelectClose(String matName ,String vehicleId, String supName, String compid, String beginTime, String endTime, Integer page, Integer pageSize,String saleType);
