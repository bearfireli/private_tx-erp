...
import com.hntxrj.mapper.ConcreteMapper;
import com.hntxrj.mapper.StockMapper;
import com.hntxrj.mapper.TaskPlanMapper;
import com.hntxrj.repository.TaskPlanRepository;
import com.hntxrj.server.TaskPlanService;
...
public class TaskPlanServiceImpl implements TaskPlanService {
    ...
    public PageVO<TaskPlanListVO> getTaskPlanList(String beginTime, String endTime,
        ...
        List<TaskPlanListVO> taskPlanListVOList = taskPlanMapper.getTaskPlanList(beginTime, endTime, eppCode,
                builderCode, placing, taskId, taskStatus, compid);
        //循环截取preTime，格式为年月日
